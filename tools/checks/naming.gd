...
const EXPECTED_SYMBOL_ROWS: Array = [
	[0, 3, [0xF1, 0x9A, 0x9B, 0x9C, 0x9D, 0x9E, 0x9F, 0xE1, 0xE2]],  # NameInputLower row 3: × ( ) : ; [ ] PK MN
	[1, 3, [0xEA, 0xD0, 0xD1, 0xD2, 0xD3, 0xD4, 0xD5, 0xD6, 0xF6]],  # BoxNameInputLower row 3: é and the seven apostrophe ligatures, then 0
	[2, 3, [0xE3, 0xE6, 0xE7, 0xF3, 0xE8, 0xF4, 0x7F, 0x7F, 0x7F]],  # NameInputUpper row 3: - ? ! / . , and three blanks
	[3, 3, [0xF1, 0x9A, 0x9B, 0x9C, 0x9D, 0x9E, 0x9F, 0xE1, 0xE2]],  # BoxNameInputUpper row 3 repeats NameInputLower's symbols
	[3, 4, [0xE3, 0xE6, 0xE7, 0xEF, 0xF5, 0xF3, 0xE8, 0xF4, 0xE9]],  # BoxNameInputUpper row 4: - ? ! ♂ ♀ / . , &
]
