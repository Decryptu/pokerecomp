...
const EXPECTED_FIRST_MONS: Array = [
	[135, 109, [85, 63, 247, 46]],  # JOLTEON/MIRACLEBERRY: THUNDERBOLT, HYPER_BEAM, SHADOW_BALL, ROAR
	[197, 146, [182, 92, 189, 213]],  # UMBREON/LEFTOVERS: PROTECT, TOXIC, MUD_SLAP, ATTRACT
	[135, 109, [85, 86, 46, 189]],  # JOLTEON/MIRACLEBERRY: THUNDERBOLT, THUNDER_WAVE, ROAR, MUD_SLAP
	[128, 174, [216, 63, 89, 231]],  # TAUROS/GOLD_BERRY: RETURN, HYPER_BEAM, EARTHQUAKE, IRON_TAIL
	[230, 174, [57, 63, 59, 225]],  # KINGDRA/GOLD_BERRY: SURF, HYPER_BEAM, BLIZZARD, DRAGONBREATH
	[230, 146, [225, 57, 63, 59]],  # KINGDRA/LEFTOVERS: DRAGONBREATH, SURF, HYPER_BEAM, BLIZZARD
	[135, 109, [85, 63, 247, 46]],  # JOLTEON/MIRACLEBERRY: THUNDERBOLT, HYPER_BEAM, SHADOW_BALL, ROAR
	[135, 109, [86, 85, 231, 46]],  # JOLTEON/MIRACLEBERRY: THUNDER_WAVE, THUNDERBOLT, IRON_TAIL, ROAR
	[197, 82, [185, 189, 236, 109]],  # UMBREON/KINGS_ROCK: FAINT_ATTACK, MUD_SLAP, MOONLIGHT, CONFUSE_RAY
	[229, 84, [242, 53, 46, 156]],  # HOUNDOOM/MINT_BERRY: CRUNCH, FLAMETHROWER, ROAR, REST
]
