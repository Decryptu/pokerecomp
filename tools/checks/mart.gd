...
## The mart's boxes and buy screen over every mart the cartridge ships:
## `MartTextFunctionPointers`, its twenty-nine `text_far` stubs and
## `MenuHeader_Buy`'s geometry, all thirty-four marts drawn.
