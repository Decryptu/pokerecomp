...
const EXPECTED_SYMBOL_ROWS: Array = [
	[0, 2, [0x94, 0x95, 0x96, 0x97, 0x98, 0x99, 0x7F, 0xF4, 0xE6, 0xE7]],  # MailEntry_Uppercase row 2: U to Z, a blank, then , ? !
	[0, 4, [0xE1, 0xE2, 0x70, 0x71, 0xEA, 0xEF, 0xF5, 0xF0, 0x75, 0xF1]],  # row 4: PK MN PO KE é ♂ ♀ ¥ … ×
	[1, 2, [0xB4, 0xB5, 0xB6, 0xB7, 0xB8, 0xB9, 0x7F, 0xE8, 0xE3, 0xF3]],  # MailEntry_Lowercase row 2: u to z, a blank, then . - /
	[1, 4, [0x72, 0x73, 0x9E, 0x9F, 0xE0, 0x9C, 0x9D, 0x7F, 0x7F, 0x7F]],  # row 4: the two quotation marks, [ ] ' : ; and three blanks
]
