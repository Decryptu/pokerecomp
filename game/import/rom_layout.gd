...
## `constants/map_constants.asm`'s `map_const` names, one row per `newgroup`,
## each from 1. pokegold ships 20 fewer maps and orders groups 4 and 11 its own way.
const MAP_NAMES_CRYSTAL: Array = [
	[
		&"OLIVINE_POKECENTER_1F", &"OLIVINE_GYM", &"OLIVINE_TIMS_HOUSE", &"OLIVINE_HOUSE_BETA",
		&"OLIVINE_PUNISHMENT_SPEECH_HOUSE", &"OLIVINE_GOOD_ROD_HOUSE", &"OLIVINE_CAFE",
		&"OLIVINE_MART", &"ROUTE_38_ECRUTEAK_GATE", &"ROUTE_39_BARN", &"ROUTE_39_FARMHOUSE",
		&"ROUTE_38", &"ROUTE_39", &"OLIVINE_CITY",
	],
	[
		&"MAHOGANY_RED_GYARADOS_SPEECH_HOUSE", &"MAHOGANY_GYM", &"MAHOGANY_POKECENTER_1F",
		&"ROUTE_42_ECRUTEAK_GATE", &"ROUTE_42", &"ROUTE_44", &"MAHOGANY_TOWN",
	],
	[
		&"SPROUT_TOWER_1F", &"SPROUT_TOWER_2F", &"SPROUT_TOWER_3F", &"TIN_TOWER_1F", &"TIN_TOWER_2F",
		&"TIN_TOWER_3F", &"TIN_TOWER_4F", &"TIN_TOWER_5F", &"TIN_TOWER_6F", &"TIN_TOWER_7F",
		&"TIN_TOWER_8F", &"TIN_TOWER_9F", &"BURNED_TOWER_1F", &"BURNED_TOWER_B1F", &"NATIONAL_PARK",
		&"NATIONAL_PARK_BUG_CONTEST", &"RADIO_TOWER_1F", &"RADIO_TOWER_2F", &"RADIO_TOWER_3F",
		&"RADIO_TOWER_4F", &"RADIO_TOWER_5F", &"RUINS_OF_ALPH_OUTSIDE",
		&"RUINS_OF_ALPH_HO_OH_CHAMBER", &"RUINS_OF_ALPH_KABUTO_CHAMBER",
		&"RUINS_OF_ALPH_OMANYTE_CHAMBER", &"RUINS_OF_ALPH_AERODACTYL_CHAMBER",
		&"RUINS_OF_ALPH_INNER_CHAMBER", &"RUINS_OF_ALPH_RESEARCH_CENTER",
		&"RUINS_OF_ALPH_HO_OH_ITEM_ROOM", &"RUINS_OF_ALPH_KABUTO_ITEM_ROOM",
		&"RUINS_OF_ALPH_OMANYTE_ITEM_ROOM", &"RUINS_OF_ALPH_AERODACTYL_ITEM_ROOM",
		&"RUINS_OF_ALPH_HO_OH_WORD_ROOM", &"RUINS_OF_ALPH_KABUTO_WORD_ROOM",
		&"RUINS_OF_ALPH_OMANYTE_WORD_ROOM", &"RUINS_OF_ALPH_AERODACTYL_WORD_ROOM", &"UNION_CAVE_1F",
		&"UNION_CAVE_B1F", &"UNION_CAVE_B2F", &"SLOWPOKE_WELL_B1F", &"SLOWPOKE_WELL_B2F",
		&"OLIVINE_LIGHTHOUSE_1F", &"OLIVINE_LIGHTHOUSE_2F", &"OLIVINE_LIGHTHOUSE_3F",
		&"OLIVINE_LIGHTHOUSE_4F", &"OLIVINE_LIGHTHOUSE_5F", &"OLIVINE_LIGHTHOUSE_6F",
		&"MAHOGANY_MART_1F", &"TEAM_ROCKET_BASE_B1F", &"TEAM_ROCKET_BASE_B2F",
		&"TEAM_ROCKET_BASE_B3F", &"ILEX_FOREST", &"GOLDENROD_UNDERGROUND",
		&"GOLDENROD_UNDERGROUND_SWITCH_ROOM_ENTRANCES", &"GOLDENROD_DEPT_STORE_B1F",
		&"GOLDENROD_UNDERGROUND_WAREHOUSE", &"MOUNT_MORTAR_1F_OUTSIDE", &"MOUNT_MORTAR_1F_INSIDE",
		&"MOUNT_MORTAR_2F_INSIDE", &"MOUNT_MORTAR_B1F", &"ICE_PATH_1F", &"ICE_PATH_B1F",
		&"ICE_PATH_B2F_MAHOGANY_SIDE", &"ICE_PATH_B2F_BLACKTHORN_SIDE", &"ICE_PATH_B3F",
		&"WHIRL_ISLAND_NW", &"WHIRL_ISLAND_NE", &"WHIRL_ISLAND_SW", &"WHIRL_ISLAND_CAVE",
		&"WHIRL_ISLAND_SE", &"WHIRL_ISLAND_B1F", &"WHIRL_ISLAND_B2F", &"WHIRL_ISLAND_LUGIA_CHAMBER",
		&"SILVER_CAVE_ROOM_1", &"SILVER_CAVE_ROOM_2", &"SILVER_CAVE_ROOM_3",
		&"SILVER_CAVE_ITEM_ROOMS", &"DARK_CAVE_VIOLET_ENTRANCE", &"DARK_CAVE_BLACKTHORN_ENTRANCE",
		&"DRAGONS_DEN_1F", &"DRAGONS_DEN_B1F", &"DRAGON_SHRINE", &"TOHJO_FALLS", &"DIGLETTS_CAVE",
		&"MOUNT_MOON", &"UNDERGROUND_PATH", &"ROCK_TUNNEL_1F", &"ROCK_TUNNEL_B1F",
		&"SAFARI_ZONE_FUCHSIA_GATE_BETA", &"SAFARI_ZONE_BETA", &"VICTORY_ROAD",
	],
	[
		&"ECRUTEAK_TIN_TOWER_ENTRANCE", &"WISE_TRIOS_ROOM", &"ECRUTEAK_POKECENTER_1F",
		&"ECRUTEAK_LUGIA_SPEECH_HOUSE", &"DANCE_THEATER", &"ECRUTEAK_MART", &"ECRUTEAK_GYM",
		&"ECRUTEAK_ITEMFINDER_HOUSE", &"ECRUTEAK_CITY",
	],
	[
		&"BLACKTHORN_GYM_1F", &"BLACKTHORN_GYM_2F", &"BLACKTHORN_DRAGON_SPEECH_HOUSE",
		&"BLACKTHORN_EMYS_HOUSE", &"BLACKTHORN_MART", &"BLACKTHORN_POKECENTER_1F",
		&"MOVE_DELETERS_HOUSE", &"ROUTE_45", &"ROUTE_46", &"BLACKTHORN_CITY",
	],
	[
		&"CINNABAR_POKECENTER_1F", &"CINNABAR_POKECENTER_2F_BETA", &"ROUTE_19_FUCHSIA_GATE",
		&"SEAFOAM_GYM", &"ROUTE_19", &"ROUTE_20", &"ROUTE_21", &"CINNABAR_ISLAND",
	],
	[
		&"CERULEAN_GYM_BADGE_SPEECH_HOUSE", &"CERULEAN_POLICE_STATION",
		&"CERULEAN_TRADE_SPEECH_HOUSE", &"CERULEAN_POKECENTER_1F", &"CERULEAN_POKECENTER_2F_BETA",
		&"CERULEAN_GYM", &"CERULEAN_MART", &"ROUTE_10_POKECENTER_1F", &"ROUTE_10_POKECENTER_2F_BETA",
		&"POWER_PLANT", &"BILLS_HOUSE", &"ROUTE_4", &"ROUTE_9", &"ROUTE_10_NORTH", &"ROUTE_24",
		&"ROUTE_25", &"CERULEAN_CITY",
	],
	[
		&"AZALEA_POKECENTER_1F", &"CHARCOAL_KILN", &"AZALEA_MART", &"KURTS_HOUSE", &"AZALEA_GYM",
		&"ROUTE_33", &"AZALEA_TOWN",
	],
	[
		&"LAKE_OF_RAGE_HIDDEN_POWER_HOUSE", &"LAKE_OF_RAGE_MAGIKARP_HOUSE",
		&"ROUTE_43_MAHOGANY_GATE", &"ROUTE_43_GATE", &"ROUTE_43", &"LAKE_OF_RAGE",
	],
	[
		&"ROUTE_32", &"ROUTE_35", &"ROUTE_36", &"ROUTE_37", &"VIOLET_CITY", &"VIOLET_MART",
		&"VIOLET_GYM", &"EARLS_POKEMON_ACADEMY", &"VIOLET_NICKNAME_SPEECH_HOUSE",
		&"VIOLET_POKECENTER_1F", &"VIOLET_KYLES_HOUSE", &"ROUTE_32_RUINS_OF_ALPH_GATE",
		&"ROUTE_32_POKECENTER_1F", &"ROUTE_35_GOLDENROD_GATE", &"ROUTE_35_NATIONAL_PARK_GATE",
		&"ROUTE_36_RUINS_OF_ALPH_GATE", &"ROUTE_36_NATIONAL_PARK_GATE",
	],
	[
		&"ROUTE_34", &"GOLDENROD_CITY", &"GOLDENROD_GYM", &"GOLDENROD_BIKE_SHOP",
		&"GOLDENROD_HAPPINESS_RATER", &"BILLS_FAMILYS_HOUSE", &"GOLDENROD_MAGNET_TRAIN_STATION",
		&"GOLDENROD_FLOWER_SHOP", &"GOLDENROD_PP_SPEECH_HOUSE", &"GOLDENROD_NAME_RATER",
		&"GOLDENROD_DEPT_STORE_1F", &"GOLDENROD_DEPT_STORE_2F", &"GOLDENROD_DEPT_STORE_3F",
		&"GOLDENROD_DEPT_STORE_4F", &"GOLDENROD_DEPT_STORE_5F", &"GOLDENROD_DEPT_STORE_6F",
		&"GOLDENROD_DEPT_STORE_ELEVATOR", &"GOLDENROD_DEPT_STORE_ROOF", &"GOLDENROD_GAME_CORNER",
		&"GOLDENROD_POKECENTER_1F", &"POKECOM_CENTER_ADMIN_OFFICE_MOBILE",
		&"ILEX_FOREST_AZALEA_GATE", &"ROUTE_34_ILEX_FOREST_GATE", &"DAY_CARE",
	],
	[
		&"ROUTE_6", &"ROUTE_11", &"VERMILION_CITY", &"VERMILION_FISHING_SPEECH_HOUSE",
		&"VERMILION_POKECENTER_1F", &"VERMILION_POKECENTER_2F_BETA", &"POKEMON_FAN_CLUB",
		&"VERMILION_MAGNET_TRAIN_SPEECH_HOUSE", &"VERMILION_MART",
		&"VERMILION_DIGLETTS_CAVE_SPEECH_HOUSE", &"VERMILION_GYM", &"ROUTE_6_SAFFRON_GATE",
		&"ROUTE_6_UNDERGROUND_PATH_ENTRANCE",
	],
	[
		&"ROUTE_1", &"PALLET_TOWN", &"REDS_HOUSE_1F", &"REDS_HOUSE_2F", &"BLUES_HOUSE", &"OAKS_LAB",
	],
	[
		&"ROUTE_3", &"PEWTER_CITY", &"PEWTER_NIDORAN_SPEECH_HOUSE", &"PEWTER_GYM", &"PEWTER_MART",
		&"PEWTER_POKECENTER_1F", &"PEWTER_POKECENTER_2F_BETA", &"PEWTER_SNOOZE_SPEECH_HOUSE",
	],
	[
		&"OLIVINE_PORT", &"VERMILION_PORT", &"FAST_SHIP_1F", &"FAST_SHIP_CABINS_NNW_NNE_NE",
		&"FAST_SHIP_CABINS_SW_SSW_NW", &"FAST_SHIP_CABINS_SE_SSE_CAPTAINS_CABIN", &"FAST_SHIP_B1F",
		&"OLIVINE_PORT_PASSAGE", &"VERMILION_PORT_PASSAGE", &"MOUNT_MOON_SQUARE",
		&"MOUNT_MOON_GIFT_SHOP", &"TIN_TOWER_ROOF",
	],
	[
		&"ROUTE_23", &"INDIGO_PLATEAU_POKECENTER_1F", &"WILLS_ROOM", &"KOGAS_ROOM", &"BRUNOS_ROOM",
		&"KARENS_ROOM", &"LANCES_ROOM", &"HALL_OF_FAME",
	],
	[
		&"ROUTE_13", &"ROUTE_14", &"ROUTE_15", &"ROUTE_18", &"FUCHSIA_CITY", &"FUCHSIA_MART",
		&"SAFARI_ZONE_MAIN_OFFICE", &"FUCHSIA_GYM", &"BILLS_OLDER_SISTERS_HOUSE",
		&"FUCHSIA_POKECENTER_1F", &"FUCHSIA_POKECENTER_2F_BETA", &"SAFARI_ZONE_WARDENS_HOME",
		&"ROUTE_15_FUCHSIA_GATE",
	],
	[
		&"ROUTE_8", &"ROUTE_12", &"ROUTE_10_SOUTH", &"LAVENDER_TOWN", &"LAVENDER_POKECENTER_1F",
		&"LAVENDER_POKECENTER_2F_BETA", &"MR_FUJIS_HOUSE", &"LAVENDER_SPEECH_HOUSE",
		&"LAVENDER_NAME_RATER", &"LAVENDER_MART", &"SOUL_HOUSE", &"LAV_RADIO_TOWER_1F",
		&"ROUTE_8_SAFFRON_GATE", &"ROUTE_12_SUPER_ROD_HOUSE",
	],
	[
		&"ROUTE_28", &"SILVER_CAVE_OUTSIDE", &"SILVER_CAVE_POKECENTER_1F",
		&"ROUTE_28_STEEL_WING_HOUSE",
	],
	[
		&"POKECENTER_2F", &"TRADE_CENTER", &"COLOSSEUM", &"TIME_CAPSULE", &"MOBILE_TRADE_ROOM",
		&"MOBILE_BATTLE_ROOM",
	],
	[
		&"ROUTE_7", &"ROUTE_16", &"ROUTE_17", &"CELADON_CITY", &"CELADON_DEPT_STORE_1F",
		&"CELADON_DEPT_STORE_2F", &"CELADON_DEPT_STORE_3F", &"CELADON_DEPT_STORE_4F",
		&"CELADON_DEPT_STORE_5F", &"CELADON_DEPT_STORE_6F", &"CELADON_DEPT_STORE_ELEVATOR",
		&"CELADON_MANSION_1F", &"CELADON_MANSION_2F", &"CELADON_MANSION_3F", &"CELADON_MANSION_ROOF",
		&"CELADON_MANSION_ROOF_HOUSE", &"CELADON_POKECENTER_1F", &"CELADON_POKECENTER_2F_BETA",
		&"CELADON_GAME_CORNER", &"CELADON_GAME_CORNER_PRIZE_ROOM", &"CELADON_GYM", &"CELADON_CAFE",
		&"ROUTE_16_FUCHSIA_SPEECH_HOUSE", &"ROUTE_16_GATE", &"ROUTE_7_SAFFRON_GATE",
		&"ROUTE_17_ROUTE_18_GATE",
	],
	[
		&"ROUTE_40", &"ROUTE_41", &"CIANWOOD_CITY", &"MANIAS_HOUSE", &"CIANWOOD_GYM",
		&"CIANWOOD_POKECENTER_1F", &"CIANWOOD_PHARMACY", &"CIANWOOD_PHOTO_STUDIO",
		&"CIANWOOD_LUGIA_SPEECH_HOUSE", &"POKE_SEERS_HOUSE", &"BATTLE_TOWER_1F",
		&"BATTLE_TOWER_BATTLE_ROOM", &"BATTLE_TOWER_ELEVATOR", &"BATTLE_TOWER_HALLWAY",
		&"ROUTE_40_BATTLE_TOWER_GATE", &"BATTLE_TOWER_OUTSIDE",
	],
	[
		&"ROUTE_2", &"ROUTE_22", &"VIRIDIAN_CITY", &"VIRIDIAN_GYM",
		&"VIRIDIAN_NICKNAME_SPEECH_HOUSE", &"TRAINER_HOUSE_1F", &"TRAINER_HOUSE_B1F",
		&"VIRIDIAN_MART", &"VIRIDIAN_POKECENTER_1F", &"VIRIDIAN_POKECENTER_2F_BETA",
		&"ROUTE_2_NUGGET_HOUSE", &"ROUTE_2_GATE", &"VICTORY_ROAD_GATE",
	],
	[
		&"ROUTE_26", &"ROUTE_27", &"ROUTE_29", &"NEW_BARK_TOWN", &"ELMS_LAB", &"PLAYERS_HOUSE_1F",
		&"PLAYERS_HOUSE_2F", &"PLAYERS_NEIGHBORS_HOUSE", &"ELMS_HOUSE", &"ROUTE_26_HEAL_HOUSE",
		&"DAY_OF_WEEK_SIBLINGS_HOUSE", &"ROUTE_27_SANDSTORM_HOUSE", &"ROUTE_29_ROUTE_46_GATE",
	],
	[
		&"ROUTE_5", &"SAFFRON_CITY", &"FIGHTING_DOJO", &"SAFFRON_GYM", &"SAFFRON_MART",
		&"SAFFRON_POKECENTER_1F", &"SAFFRON_POKECENTER_2F_BETA", &"MR_PSYCHICS_HOUSE",
		&"SAFFRON_MAGNET_TRAIN_STATION", &"SILPH_CO_1F", &"COPYCATS_HOUSE_1F", &"COPYCATS_HOUSE_2F",
		&"ROUTE_5_UNDERGROUND_PATH_ENTRANCE", &"ROUTE_5_SAFFRON_GATE", &"ROUTE_5_CLEANSE_TAG_HOUSE",
	],
	[
		&"ROUTE_30", &"ROUTE_31", &"CHERRYGROVE_CITY", &"CHERRYGROVE_MART",
		&"CHERRYGROVE_POKECENTER_1F", &"CHERRYGROVE_GYM_SPEECH_HOUSE", &"GUIDE_GENTS_HOUSE",
		&"CHERRYGROVE_EVOLUTION_SPEECH_HOUSE", &"ROUTE_30_BERRY_HOUSE", &"MR_POKEMONS_HOUSE",
		&"ROUTE_31_VIOLET_GATE",
	],
]
const MAP_NAMES_GOLD_SILVER: Array = [
	[
		&"OLIVINE_POKECENTER_1F", &"OLIVINE_GYM", &"OLIVINE_TIMS_HOUSE", &"OLIVINE_HOUSE_BETA",
		&"OLIVINE_PUNISHMENT_SPEECH_HOUSE", &"OLIVINE_GOOD_ROD_HOUSE", &"OLIVINE_CAFE",
		&"OLIVINE_MART", &"ROUTE_38_ECRUTEAK_GATE", &"ROUTE_39_BARN", &"ROUTE_39_FARMHOUSE",
	...
	[
		...
		&"RUINS_OF_ALPH_HO_OH_CHAMBER", &"RUINS_OF_ALPH_KABUTO_CHAMBER",
		&"RUINS_OF_ALPH_OMANYTE_CHAMBER", &"RUINS_OF_ALPH_AERODACTYL_CHAMBER",
		&"RUINS_OF_ALPH_INNER_CHAMBER", &"RUINS_OF_ALPH_RESEARCH_CENTER", &"UNION_CAVE_1F",
		&"UNION_CAVE_B1F", &"UNION_CAVE_B2F", &"SLOWPOKE_WELL_B1F", &"SLOWPOKE_WELL_B2F",
		&"OLIVINE_LIGHTHOUSE_1F", &"OLIVINE_LIGHTHOUSE_2F", &"OLIVINE_LIGHTHOUSE_3F",
		&"OLIVINE_LIGHTHOUSE_4F", &"OLIVINE_LIGHTHOUSE_5F", &"OLIVINE_LIGHTHOUSE_6F",
		&"MAHOGANY_MART_1F", &"TEAM_ROCKET_BASE_B1F", &"TEAM_ROCKET_BASE_B2F",
		...
		&"SILVER_CAVE_ROOM_1", &"SILVER_CAVE_ROOM_2", &"SILVER_CAVE_ROOM_3",
		&"SILVER_CAVE_ITEM_ROOMS", &"DARK_CAVE_VIOLET_ENTRANCE", &"DARK_CAVE_BLACKTHORN_ENTRANCE",
		&"DRAGONS_DEN_1F", &"DRAGONS_DEN_B1F", &"TOHJO_FALLS", &"DIGLETTS_CAVE", &"MOUNT_MOON",
		&"UNDERGROUND_PATH", &"ROCK_TUNNEL_1F", &"ROCK_TUNNEL_B1F", &"SAFARI_ZONE_FUCHSIA_GATE_BETA",
		&"SAFARI_ZONE_BETA", &"VICTORY_ROAD",
	],
	[
		&"ECRUTEAK_TIN_TOWER_ENTRANCE", &"ECRUTEAK_TIN_TOWER_BACK_ENTRANCE",
		&"ECRUTEAK_POKECENTER_1F", &"ECRUTEAK_LUGIA_SPEECH_HOUSE", &"DANCE_THEATER",
		&"ECRUTEAK_MART", &"ECRUTEAK_GYM", &"ECRUTEAK_ITEMFINDER_HOUSE", &"ECRUTEAK_CITY",
	],
	[
		&"BLACKTHORN_GYM_1F", &"BLACKTHORN_GYM_2F", &"BLACKTHORN_DRAGON_SPEECH_HOUSE",
		&"BLACKTHORN_EMYS_HOUSE", &"BLACKTHORN_MART", &"BLACKTHORN_POKECENTER_1F",
	...
	[
		&"ROUTE_34", &"GOLDENROD_CITY", &"GOLDENROD_GYM", &"GOLDENROD_BIKE_SHOP",
		&"GOLDENROD_HAPPINESS_RATER", &"BILLS_FAMILYS_HOUSE", &"GOLDENROD_MAGNET_TRAIN_STATION",
		&"GOLDENROD_FLOWER_SHOP", &"GOLDENROD_POKECENTER_1F", &"GOLDENROD_PP_SPEECH_HOUSE",
		&"GOLDENROD_NAME_RATER", &"GOLDENROD_DEPT_STORE_1F", &"GOLDENROD_DEPT_STORE_2F",
		&"GOLDENROD_DEPT_STORE_3F", &"GOLDENROD_DEPT_STORE_4F", &"GOLDENROD_DEPT_STORE_5F",
		&"GOLDENROD_DEPT_STORE_6F", &"GOLDENROD_DEPT_STORE_ELEVATOR", &"GOLDENROD_GAME_CORNER",
		&"ILEX_FOREST_AZALEA_GATE", &"ROUTE_34_ILEX_FOREST_GATE", &"DAY_CARE",
	],
	[
		&"ROUTE_6", &"ROUTE_11", &"VERMILION_CITY", &"VERMILION_FISHING_SPEECH_HOUSE",
	...
	[
		&"POKECENTER_2F", &"TRADE_CENTER", &"COLOSSEUM", &"TIME_CAPSULE",
	],
	[
		&"ROUTE_7", &"ROUTE_16", &"ROUTE_17", &"CELADON_CITY", &"CELADON_DEPT_STORE_1F",
		&"CELADON_DEPT_STORE_2F", &"CELADON_DEPT_STORE_3F", &"CELADON_DEPT_STORE_4F",
...
static func map_name(crystal: bool, group: int, number: int) -> StringName:
	var groups: Array = MAP_NAMES_CRYSTAL if crystal else MAP_NAMES_GOLD_SILVER
	if group < 1 or group > groups.size():
		return &""
	var names: Array = groups[group - 1]
	return names[number - 1] if number >= 1 and number <= names.size() else &""
