...
const OAM_SETS: Array[Dictionary] = [
	{"vtile": 0x4C, "parts": [[-4, -4, 0x00, 0x00]]},  # 0: BUBBLE_1 (1x1_Palette0, 1)
	{"vtile": 0x5C, "parts": [[-4, -4, 0x00, 0x00]]},  # 1: BUBBLE_2 (1x1_Palette0, 1)
	{"vtile": 0x6C, "parts": [  # 2: SHELLDER_1 (GSIntroShellder, 4)
		[-8, -8, 0x00, 0x00], [-8, 0, 0x01, 0x00], [0, -8, 0x10, 0x00],
		[0, 0, 0x11, 0x00],
	]},
	{"vtile": 0x6E, "parts": [  # 3: SHELLDER_2 (GSIntroShellder, 4)
		[-8, -8, 0x00, 0x00], [-8, 0, 0x01, 0x00], [0, -8, 0x10, 0x00],
		[0, 0, 0x11, 0x00],
	]},
	{"vtile": 0x2D, "parts": [  # 4: MAGIKARP_1 (GSIntroMagikarp, 6)
		[-8, -12, 0x00, 0x01], [-8, -4, 0x01, 0x01], [-8, 4, 0x02, 0x01],
		[0, -12, 0x10, 0x01], [0, -4, 0x11, 0x01], [0, 4, 0x12, 0x01],
	]},
	{"vtile": 0x4D, "parts": [  # 5: MAGIKARP_2 (GSIntroMagikarp, 6)
		[-8, -12, 0x00, 0x01], [-8, -4, 0x01, 0x01], [-8, 4, 0x02, 0x01],
		[0, -12, 0x10, 0x01], [0, -4, 0x11, 0x01], [0, 4, 0x12, 0x01],
	]},
	{"vtile": 0x00, "parts": [  # 6: LAPRAS_1 (GSIntroLapras1, 27)
	...
	{"vtile": 0x00, "parts": [  # 7: LAPRAS_2 (GSIntroLapras2, 27)
	...
	{"vtile": 0x06, "parts": [  # 8: LAPRAS_3 (GSIntroLapras3, 29)
		[-24, -24, 0x00, 0x00], [-24, -16, 0x01, 0x00], [-24, -8, 0x02, 0x00],
	...
	{"vtile": 0x0C, "parts": [[-8, -4, 0x00, 0x00], [0, -4, 0x10, 0x00]]},  # 9: NOTE (GSIntroNote, 2)
	{"vtile": 0x0D, "parts": [[-4, -4, 0x00, 0x00]]},  # 10: INVISIBLE_NOTE (1x1_Palette0, 1)
	{"vtile": 0x00, "parts": [  # 11: JIGGLYPUFF_1 (GSIntroJigglypuffPikachu, 16)
	...
	{"vtile": 0x04, "parts": [  # 12: JIGGLYPUFF_2 (GSIntroJigglypuffPikachu, 16)
		[-16, -16, 0x00, 0x00], [-16, -8, 0x01, 0x00], [-16, 0, 0x02, 0x00],
		[-16, 8, 0x03, 0x00], [-8, -16, 0x10, 0x00], [-8, -8, 0x11, 0x00],
		[-8, 0, 0x12, 0x00], [-8, 8, 0x13, 0x00], [0, -16, 0x20, 0x00],
		[0, -8, 0x21, 0x00], [0, 0, 0x22, 0x00], [0, 8, 0x23, 0x00],
	...
	{"vtile": 0x08, "parts": [  # 13: JIGGLYPUFF_3 (GSIntroJigglypuffPikachu, 16)
		[-16, -16, 0x00, 0x00], [-16, -8, 0x01, 0x00], [-16, 0, 0x02, 0x00],
		[-16, 8, 0x03, 0x00], [-8, -16, 0x10, 0x00], [-8, -8, 0x11, 0x00],
		[-8, 0, 0x12, 0x00], [-8, 8, 0x13, 0x00], [0, -16, 0x20, 0x00],
		[0, -8, 0x21, 0x00], [0, 0, 0x22, 0x00], [0, 8, 0x23, 0x00],
	...
	{"vtile": 0x40, "parts": [  # 14: PIKACHU_1 (GSIntroJigglypuffPikachu, 16)
		[-16, -16, 0x00, 0x00], [-16, -8, 0x01, 0x00], [-16, 0, 0x02, 0x00],
		[-16, 8, 0x03, 0x00], [-8, -16, 0x10, 0x00], [-8, -8, 0x11, 0x00],
		[-8, 0, 0x12, 0x00], [-8, 8, 0x13, 0x00], [0, -16, 0x20, 0x00],
		[0, -8, 0x21, 0x00], [0, 0, 0x22, 0x00], [0, 8, 0x23, 0x00],
	...
	{"vtile": 0x44, "parts": [  # 15: PIKACHU_2 (GSIntroJigglypuffPikachu, 16)
		[-16, -16, 0x00, 0x00], [-16, -8, 0x01, 0x00], [-16, 0, 0x02, 0x00],
		[-16, 8, 0x03, 0x00], [-8, -16, 0x10, 0x00], [-8, -8, 0x11, 0x00],
		[-8, 0, 0x12, 0x00], [-8, 8, 0x13, 0x00], [0, -16, 0x20, 0x00],
		[0, -8, 0x21, 0x00], [0, 0, 0x22, 0x00], [0, 8, 0x23, 0x00],
	...
	{"vtile": 0x48, "parts": [  # 16: PIKACHU_3 (GSIntroJigglypuffPikachu, 16)
		[-16, -16, 0x00, 0x00], [-16, -8, 0x01, 0x00], [-16, 0, 0x02, 0x00],
		[-16, 8, 0x03, 0x00], [-8, -16, 0x10, 0x00], [-8, -8, 0x11, 0x00],
		[-8, 0, 0x12, 0x00], [-8, 8, 0x13, 0x00], [0, -16, 0x20, 0x00],
		[0, -8, 0x21, 0x00], [0, 0, 0x22, 0x00], [0, 8, 0x23, 0x00],
	...
	{"vtile": 0x4C, "parts": [  # 17: PIKACHU_4 (GSIntroJigglypuffPikachu, 16)
		[-16, -16, 0x00, 0x00], [-16, -8, 0x01, 0x00], [-16, 0, 0x02, 0x00],
		[-16, 8, 0x03, 0x00], [-8, -16, 0x10, 0x00], [-8, -8, 0x11, 0x00],
		[-8, 0, 0x12, 0x00], [-8, 8, 0x13, 0x00], [0, -16, 0x20, 0x00],
		[0, -8, 0x21, 0x00], [0, 0, 0x22, 0x00], [0, 8, 0x23, 0x00],
	...
	{"vtile": 0x80, "parts": [  # 18: PIKACHU_TAIL_1 (GSIntroPikachuTail, 5)
		[-16, 24, 0x00, 0x00], [-16, 32, 0x01, 0x00], [-8, 16, 0x02, 0x00],
		[-8, 24, 0x03, 0x00], [0, 16, 0x04, 0x00],
	]},
	{"vtile": 0x85, "parts": [  # 19: PIKACHU_TAIL_2 (GSIntroPikachuTail, 5)
		[-16, 24, 0x00, 0x00], [-16, 32, 0x01, 0x00], [-8, 16, 0x02, 0x00],
		[-8, 24, 0x03, 0x00], [0, 16, 0x04, 0x00],
	]},
	{"vtile": 0x8A, "parts": [  # 20: PIKACHU_TAIL_3 (GSIntroPikachuTail, 5)
		[-16, 24, 0x00, 0x00], [-16, 32, 0x01, 0x00], [-8, 16, 0x02, 0x00],
		[-8, 24, 0x03, 0x00], [0, 16, 0x04, 0x00],
	]},
	{"vtile": 0x00, "parts": [  # 21: SMALL_FIREBALL (GSIntroSmallFireball, 4)
		[-8, -8, 0x00, 0x00], [-8, 0, 0x00, 0x20], [0, -8, 0x00, 0x40],
		[0, 0, 0x00, 0x60],
	]},
	{"vtile": 0x01, "parts": [  # 22: MED_FIREBALL (TradePoofBubble, 16)
	...
	{"vtile": 0x09, "parts": [  # 23: BIG_FIREBALL (GSIntroBigFireball, 36)
		[-24, -24, 0x00, 0x00], [-24, -16, 0x01, 0x00], [-24, -8, 0x02, 0x00],
	...
	{"vtile": 0x10, "parts": [  # 24: CHIKORITA (GSIntroStarter, 25)
	...
	{"vtile": 0x29, "parts": [  # 25: CYNDAQUIL (GSIntroStarter, 25)
		[-20, -20, 0x00, 0x00], [-12, -20, 0x01, 0x00], [-4, -20, 0x02, 0x00],
		[4, -20, 0x03, 0x00], [12, -20, 0x04, 0x00], [-20, -12, 0x05, 0x00],
		[-12, -12, 0x06, 0x00], [-4, -12, 0x07, 0x00], [4, -12, 0x08, 0x00],
		[12, -12, 0x09, 0x00], [-20, -4, 0x0A, 0x00], [-12, -4, 0x0B, 0x00],
	...
	{"vtile": 0x42, "parts": [  # 26: TOTODILE (GSIntroStarter, 25)
		[-20, -20, 0x00, 0x00], [-12, -20, 0x01, 0x00], [-4, -20, 0x02, 0x00],
		[4, -20, 0x03, 0x00], [12, -20, 0x04, 0x00], [-20, -12, 0x05, 0x00],
		[-12, -12, 0x06, 0x00], [-4, -12, 0x07, 0x00], [4, -12, 0x08, 0x00],
		[12, -12, 0x09, 0x00], [-20, -4, 0x0A, 0x00], [-12, -4, 0x0B, 0x00],
